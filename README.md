...
Please Note: The current version of this code includes advanced modules—specifically Induced Set Attention Blocks (ISAB) and Pooling by Multihead Attention (PMA) which are part of a follow-up publication under review-please do not reproduce or build upon them without permission.
